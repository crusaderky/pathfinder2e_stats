...
extlinks = {
    ...
    "prd_classes": ("https://2e.aonprd.com/Classes.aspx?ID=%s", None),
    ...
    "prd_skills": ("https://2e.aonprd.com/Skills.aspx?ID=%s", None),
...
copyright = f"2020-{datetime.datetime.now().year}, pathfinder2e_stats Developers"
...
version = pathfinder2e_stats.__version__.split("+")[0]
# The full version, including alpha/beta/rc tags.
release = pathfinder2e_stats.__version__
...
htmlhelp_basename = "pathfinder2e_statsdoc"
